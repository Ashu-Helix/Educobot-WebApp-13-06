...
const GAME_CONSTANT = {
    images: {
        Full_Moon_Background: 'gameAssets/Full_Moon_Background.png',
        NO_MOON_Background: 'gameAssets/NO_MOON_Background.jpg',
        ma: 'gameAssets/ma.png',
        mb: 'gameAssets/mb.png',
        mc: 'gameAssets/mc.png',
        md: 'gameAssets/md.png',
        me: 'gameAssets/me.png',
        mf: 'gameAssets/mf.png',
        mg: 'gameAssets/mg.png',
        mh: 'gameAssets/mh.png',

        Smoon: 'gameAssets/Smoon.png',
...
function loadImages() {
    ...
    for (const key in spritesImages) {
        if (Object.hasOwnProperty.call(spritesImages, key)) {
            ...
            _gameThis.load.spritesheet(key, "gameAssets/" + element + ".png", {
